...
def get_model_folder( argv ):
    if( len( argv ) != 2 ):
        return './research_drive/joris2/bert-base-dutch-cased-finetuned-conll2002-ner'
    else:
        return './bert-base-dutch-cased-finetuned-conll2002-ner'
...
tokenizer = AutoTokenizer.from_pretrained( get_model_folder( sys.argv) )
model = AutoModelForTokenClassification.from_pretrained( get_model_folder( sys.argv ) )
